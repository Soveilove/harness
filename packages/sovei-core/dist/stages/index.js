...
`,
    ...
    async postExecute(ctx, result) {
        ...
        if (!artifact)
            throw new Error('decision-log.md not generated');
    },
});
// ──────────────────────────────────────────────
...
`,
    ...
    async postExecute(ctx) {
        ...
        if (!artifact)
            throw new Error('wayfinder.md not generated');
    },
});
// ──────────────────────────────────────────────
...
`,
    ...
    async postExecute(ctx) {
        ...
        if (!artifact)
            throw new Error('spec.md not generated');
    },
});
// ──────────────────────────────────────────────
...
`,
    ...
    async postExecute(ctx) {
        ...
        if (!scope)
            throw new Error('scope.md not generated');
        if (!matrix)
            throw new Error('coverage-matrix.md not generated');
    },
});
// ──────────────────────────────────────────────
...
`,
    ...
    async postExecute(ctx) {
        ...
        if (!artifact)
            throw new Error('plan.md not generated');
    },
});
// ──────────────────────────────────────────────
...
`,
    ...
    async postExecute(ctx) {
        ...
        if (!artifact)
            throw new Error('tasks.md not generated');
    },
});
// ──────────────────────────────────────────────
...
`,
    ...
    async postExecute(ctx) {
        ...
        if (!artifact)
            throw new Error('change-manifest.md not generated');
    },
});
// ──────────────────────────────────────────────
...
`,
    ...
    async postExecute(ctx) {
        ...
        if (!artifact)
            throw new Error('convergence-report.md not generated');
    },
});
// ──────────────────────────────────────────────
...
`,
    ...
    async postExecute(ctx) {
        ...
        if (!artifact)
            throw new Error('evidence.md not generated');
    },
});
// ──────────────────────────────────────────────
...
`,
    ...
    async postExecute(ctx) {
        ...
        if (!artifact)
            throw new Error('learning-report.md not generated');
    },
});
// ──────────────────────────────────────────────
...
`,
    ...
    async postExecute(ctx) {
        ...
        if (!artifact)
            throw new Error('sync-report.md not generated');
    },
});
// ──────────────────────────────────────────────
// Register all stages
