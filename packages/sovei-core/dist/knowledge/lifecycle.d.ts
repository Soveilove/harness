 ...
 */
export declare function validatePromotion(entry: KnowledgeEntry, to: Lifecycle, hasNewEvidence: boolean): {
    valid: boolean;
    reason?: string;
};
/**
 ...
 */
export declare function nextLifecycle(entry: KnowledgeEntry): Lifecycle | null;
