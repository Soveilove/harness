...
export class ProjectScanner {
  ...
  async scan(maxDepth = 4): Promise<ScanResult> {
    ...
    const codeMapLines: string[] = ['# Auto-Generated Code Map', '', '> Generated by sovei project onboard.', '', '## Tech Stack', ''];
    ...
    if (detectedPatterns.length > 0) {
      const archLines: string[] = ['# Auto-Detected Architecture', '', '> Generated by sovei project onboard.', ''];
      if (packageJson?.name) archLines.push('## Project: ' + packageJson.name, '');
