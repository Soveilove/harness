...
| 落点 | 文件 | 格式 |
|---|---|---|
| Vue 陷阱 | `<harness-root>/project/memory/vue-pitfalls.md` | 见 systematic-debugging.md 模板 |
| 违反规则 | `<harness-root>/project/rules/implementation-rules.md` | 补充具体要求 |
| 架构模式问题 | `<harness-root>/project/rules/rejected-patterns.md` | RP-XXX 模板 |
| 架构决策 | `<harness-root>/project/memory/design-decisions.md` | 新 ADR |
| 候选规则 | `<harness-root>/project/rules/pending-rules.md` | P-XXX 模板 |
